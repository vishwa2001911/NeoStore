...
const choosenProductColor= document.querySelectorAll(".color");
const choosenProductSize= document.querySelectorAll(".size");
...
menuItems.forEach((item,index) => {
    item.addEventListener("click", () => {
        ...
        choosenProductColor.forEach((color, index) => {
...
choosenProductSize.forEach((size,index)=>{
  size.addEventListener('click',()=>{
    choosenProductSize.forEach((size)=>{
